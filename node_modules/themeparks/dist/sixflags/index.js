                ...
                this.GetAPIUrl({
                    ...
                    for (var i = 0, day; day = scheduleData.operatingHours[i++];) {
                        ...
                        this.Schedule.SetDate({
                            openingTime: day.open ? Moment(day.open, "YYYY-MM-DDTHH:mm:ss").tz(this.Timezone) : thisDay,
                            closingTime: day.close ? Moment(day.close, "YYYY-MM-DDTHH:mm:ss").tz(this.Timezone) : thisDay,
                            type: "Operating"
                        });
                    }
